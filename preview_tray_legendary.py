...
def create_legendary_preview(minutes: int, size: int = 128):
    """Generate a preview of the legendary style tray icon."""
    ...
    # Scale width from 64px base (4px) to current size
...
def main():
    ...
    print(f"Generating legendary preview icons in {output_dir.absolute()}...")
    
    for mins in examples:
        pixmap = create_legendary_preview(mins)
        filename = output_dir / f"legendary_preview_{mins}min.png"
